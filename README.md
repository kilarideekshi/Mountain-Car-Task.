...
06/06/2026, 00:08 chowlachaithanya/Mountain-Car-Task.
https://github.com/chowlachaithanya/Mountain-Car-Task. 2/5
    while not done:
        # Epsilon-Greedy
...
06/06/2026, 00:08 chowlachaithanya/Mountain-Car-Task.
https://github.com/chowlachaithanya/Mountain-Car-Task. 3/5

The Mountain Car Reinforcement Learning task was successfully implemented using the Q-Learning algorithm. The agent
learned an optimal policy through interaction with the environment and progressively improved its ability to reach the
goal state. The learning curve confirms the effectiveness of the training process.
Releases
...
<img width="458" height="577" alt="image" src="https://github.com/user-attachments/assets/d0298b3e-00a9-4cac-b719-22cff80608fb" />
